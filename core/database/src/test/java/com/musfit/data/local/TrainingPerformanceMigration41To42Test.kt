...
class TrainingPerformanceMigration41To42Test {
    ...
    private fun resolveSchemaFile(version: Int): File {
        ...
        return listOf(File(relative), File("app/$relative"), File("../app/$relative"), File("../../app/$relative")).firstOrNull(File::exists) ?: error("Could not find exported Room schema $version")
    }
