...
// Macro trio — distinct from every tab container they sit on. Protein moved
// from teal to rose (Turn 8 Delta 2) so it never collides with Profile's teal.
...
// Rose lifted for dark cards (≈7.5:1 vs DarkBg — comfortably AA).
val MacroProteinDark = Color(0xFFF2839D)
